// Write a program using synchronization, where use 2 student class.(studentA, studentB). These studentA and 
// studentB class has to print their teacher names of their courses.(use synchronized courseteacher method).
