// Write a Java program to create a class Employee with a method called Salary(). Create two subclasses 
// headit and programmer. In each subclass, override the Salary() method to calculate and return the salary 
// based on their specific roles.

package CO3.Worksheet3;
